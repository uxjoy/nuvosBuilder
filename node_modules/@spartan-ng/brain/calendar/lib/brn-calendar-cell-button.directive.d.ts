...
export declare class BrnCalendarCellButtonDirective<T> {
    ...
    focus(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<BrnCalendarCellButtonDirective<any>, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<BrnCalendarCellButtonDirective<any>, "button[brnCalendarCellButton]", never, { "date": { "alias": "date"; "required": true; "isSignal": true; }; }, {}, never, never, true, never>;
}
